...
#}
#classname_to_id = {
#    "linear_defects": 0, #改成自己的类别
#    "punctiform_pits": 1,
#    "uneven_paint_spray": 2,
#}
classname_to_id = {
    "crack": 0,   # 改成自己的类别
    "pit": 1,
...
if __name__ == '__main__':
    labelme_path = "/root/mmdetection/data/jpg"   # E:/YOLOV5/mmdetection-main/data/jpg
    saved_coco_path = "/root/mmdetection/data/cocoREL"   #  E:/YOLOV5/mmdetection-main/data/cocoREL
    print('reading...')
    # 创建文件
